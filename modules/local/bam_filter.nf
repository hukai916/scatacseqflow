...
process BAM_FILTER {
    ...
    samtools view -h -b $bam ${chromosomes[@]} | awk 'BEGIN{FS=OFS="\\t"} function abs(v) {return v < 0 ? -v : v}; /^@/ || (\$7 == "=" && (\$2 == 99 || \$2 == 147 || \$2 == 83 || \$2 == 163) && abs(\$9) <= 2000 && abs(\$9) >= 38 && \$5 >= 20 ) {print}' | samtools view -h -b -o ${bam.baseName}.filtered.bam
