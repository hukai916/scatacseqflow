...
workflow PREPROCESS {
  ...
  if (params.preprocess == "default") {
    ...
    if (!(params.barcode_whitelist)) {
      ...
      MATCH_READS.out.sample_name.collect().view()
      MATCH_READS.out.barcode_fastq.collect().view()
      MATCH_READS.out.read1_fastq.collect().view()
      ...
      // ADD_BARCODE_TO_READS (CORRECT_BARCODE.out.sample_name, CORRECT_BARCODE.out.corrected_barcode, CORRECT_BARCODE.out.read1_fastq, CORRECT_BARCODE.out.read2_fastq)
    }
